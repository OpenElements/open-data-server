...
public record ProjectDTO(
        ...
        @Nullable @Schema(description = "Path to the logo of the project", example = "logo.svg", required = false) String svgLogoForBrightBackground,
        @Nullable @Schema(description = "Path to the logo of the project", example = "logo.svg", required = false) String svgLogoForDarkBackground,
        @Nullable @Schema(description = "Path to the logo of the project", example = "logo.png", required = false) String pngLogoForBrightBackground,
        @Nullable @Schema(description = "Path to the logo of the project", example = "logo.png", required = false) String pngLogoForDarkBackground,
